...
const trendingDiscussions = [
  {
    ...
    image: "path/to/draft-services-banner.jpg", // Replace with actual path
  ...
  },
  {
    ...
    image: "path/to/draft-tech-banner.jpg", // Replace with actual path
    lastDate: "Oct 31 2025 - 5:30pm",
    link: "#tech-standards",
  },
  {
    ...
    image: "path/to/mann-ki-baat-banner.jpg", // Replace with actual path
  ...
  },
  {
    ...
    image: "path/to/digital-safety-banner.jpg", // Replace with actual path
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <img
              src="path/to/cooperatives-essay-banner.jpg" // Replace with actual path
            ...
            <div className="absolute top-4 right-4 flex space-x-2">
              ...
              <img src="path/to/ndc-logo.png" alt="Logo" className="w-8 h-8" />
              <img
                src="path/to/iocoop-logo.png"
                alt="Logo"
                className="w-8 h-8"
              />
            </div>
